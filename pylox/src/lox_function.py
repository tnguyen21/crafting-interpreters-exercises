...
class LoxFunction(LoxCallable):
    def __init__(self, declaration, closure, is_initializer):
        self.declaration,self.closure,self.is_initializer = declaration,closure,is_initializer

    def __str__(self): return f"<fn {self.declaration.name.lexeme}>"
    ...
    def arity(self): return len(self.declaration.params)
